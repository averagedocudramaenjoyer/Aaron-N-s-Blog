...
We have teamed up with FFED ISU Extension and Outreach to produce an app to help evaluate the feasibility of rural grocery stores based on their proposed location. Our hope is to help both entrepreneurs and consumers alike by aiding in the establishment of profitable stores and increasing access to high quality food in areas where this access may be limited.
...
> ![This is the map being generated by the R Shiny script after being given an address. Blue regions denote city boundaries, and green circles show store locations.](images/Map_Demo.png)
...
> ![This is a visualization of the Haversine formula on a sphere.](images/Law-of-haversines.png){width="300"}
...
Many of the functions used in this package incorporate percentages taken from both Bizminer and Vertical IQ, two financial analysis and market research firms. The value of these percentages determine how much of the total estimated revenue will be spent on a given category of expense. These percentages are based on industry 3-year averages for grocery stores as of 2022. In this tool, these default percentages are derived from each of the averages taken from Bizminer and Vertical IQ's individual 3-year averages for every expense category. Although the user has the freedom to choose their own percentage via sliders in the side panel, these Bizminer/Vertical IQ percentages are set as defaults.
